...
def train(h):
    ...
    trainset = Dataset(training_filelist, h.segment_size, h.n_fft,
                       h.hop_size, h.win_size, h.transit_hop_size, h.sampling_rate, split=True, shuffle=True, n_cache_reuse=0, device=device)
    ...
    validset = Dataset(validation_filelist, h.segment_size, h.n_fft,
                       h.hop_size, h.win_size, h.transit_hop_size, h.sampling_rate, split=False, shuffle=False, n_cache_reuse=0, device=device)
